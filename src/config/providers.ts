...
export const PROVIDERS: Record<string, ProviderInfo> = {
  ...
  xai: {
    ...
    docsUrl:
      "https://ai-sdk.dev/providers/ai-sdk-providers/xai#model-capabilities",
  },
  ...
  openrouter: {
    ...
    docsUrl:
      "https://ai-sdk.dev/providers/community-providers/openrouter#model-capabilities",
  ...
  groq: {
    ...
    docsUrl:
      "https://ai-sdk.dev/providers/ai-sdk-providers/groq#model-capabilities",
  ...
  mistral: {
    ...
    docsUrl:
      "https://ai-sdk.dev/providers/ai-sdk-providers/mistral#model-capabilities",
  },
...
export function listProviders(): void {
  ...
  Object.entries(PROVIDERS).forEach(([key, provider]) => {
    ...
    console.log(
      `  ${chalk.bold("Sample Models:")} ${chalk.gray(provider.models.join(", "))}`,
    );
    console.log(
      `  ${chalk.bold("Documentation:")} ${chalk.gray(provider.docsUrl)}`,
    );

    // Show complete model list URL if available
    if (provider.modelsListUrl) {
      console.log(
        `  ${chalk.bold("All Models:")} ${chalk.gray(provider.modelsListUrl)}`,
      );
    }
